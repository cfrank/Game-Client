...
public class ClippingPlane {
	...
	public boolean method420(int i, int j, int k, int l, int i1, int j1, int k1) {
		...
		if (l == 0)
			if (k1 == 0) {
				if (i1 == i - 1 && j1 == k)
					return true;
				if (i1 == i && j1 == k + 1 && (adjacency[i1][j1] & 0x1280120) == 0)
					return true;
				if (i1 == i && j1 == k - 1 && (adjacency[i1][j1] & 0x1280102) == 0)
					return true;
			} else if (k1 == 1) {
				if (i1 == i && j1 == k + 1)
					return true;
				if (i1 == i - 1 && j1 == k && (adjacency[i1][j1] & 0x1280108) == 0)
					return true;
				if (i1 == i + 1 && j1 == k && (adjacency[i1][j1] & 0x1280180) == 0)
					return true;
			} else if (k1 == 2) {
				if (i1 == i + 1 && j1 == k)
					return true;
		...
		if (l == 9) {
			if (i1 == i && j1 == k + 1 && (adjacency[i1][j1] & 0x20) == 0)
				return true;
			if (i1 == i && j1 == k - 1 && (adjacency[i1][j1] & 2) == 0)
				return true;
			if (i1 == i - 1 && j1 == k && (adjacency[i1][j1] & 8) == 0)
				return true;
			if (i1 == i + 1 && j1 == k && (adjacency[i1][j1] & 0x80) == 0)
				return true;
		}
		return false;
	}
	...
	public boolean method421(int i, int j, int k, int l, int i1, int j1, int k1) {
		...
		if (j1 == 6 || j1 == 7) {
			if (j1 == 7)
				i1 = i1 + 2 & 3;
			if (i1 == 0) {
				if (l == k + 1 && j == k1 && (adjacency[l][j] & 0x80) == 0)
					return true;
				if (l == k && j == k1 - 1 && (adjacency[l][j] & 2) == 0)
					return true;
			} else if (i1 == 1) {
				if (l == k - 1 && j == k1 && (adjacency[l][j] & 8) == 0)
					return true;
				if (l == k && j == k1 - 1 && (adjacency[l][j] & 2) == 0)
					return true;
			} else if (i1 == 2) {
				if (l == k - 1 && j == k1 && (adjacency[l][j] & 8) == 0)
					return true;
				if (l == k && j == k1 + 1 && (adjacency[l][j] & 0x20) == 0)
					return true;
			} else if (i1 == 3) {
				if (l == k + 1 && j == k1 && (adjacency[l][j] & 0x80) == 0)
					return true;
	...
	public boolean method422(int i, int j, boolean flag, int k, int l, int i1, int j1, int k1) {
		...
		if (j >= k && j <= l1 && k1 >= j1 && k1 <= i2)
			return true;
		if (j == k - 1 && k1 >= j1 && k1 <= i2 && (adjacency[j - anInt753][k1 - anInt754] & 8) == 0
				&& (l & 8) == 0)
			return true;
		if (j == l1 + 1 && k1 >= j1 && k1 <= i2 && (adjacency[j - anInt753][k1 - anInt754] & 0x80) == 0
				&& (l & 2) == 0)
			return true;
		if (k1 == j1 - 1 && j >= k && j <= l1 && (adjacency[j - anInt753][k1 - anInt754] & 2) == 0
				&& (l & 4) == 0)
			return true;
		return k1 == i2 + 1 && j >= k && j <= l1 && (adjacency[j - anInt753][k1 - anInt754] & 0x20) == 0
				&& (l & 1) == 0;
	}
