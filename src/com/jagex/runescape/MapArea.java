...
public class MapArea {
	...
	public static void method165(int i, int i_15_, int i_16_, int i_17_, ClippingPlane class46, int i_18_, int i_19_,
		...
		if (i_20_ == 0) {
			...
			if (i_16_ == 22) {
				...
				if (class47.anInt803 == -1 && class47.childrenIds == null)
					class50_sub1_sub4 = class47.getGameObjectModel(22, i_18_, i_22_, i_23_, i_24_, i_25_, -1);
				else
					class50_sub1_sub4 = new GameObject(i, i_18_, 22, i_23_, i_24_, i_22_, i_25_, class47.anInt803,
                            true);
				...
				if (class47.anInt803 == -1 && class47.childrenIds == null)
					...
					class50_sub1_sub4 = new GameObject(i, i_18_, 10, i_23_, i_24_, i_22_, i_25_, class47.anInt803,
                            true);
				...
				if (class47.anInt803 == -1 && class47.childrenIds == null)
					...
					class50_sub1_sub4 = new GameObject(i, i_18_, i_16_, i_23_, i_24_, i_22_, i_25_, class47.anInt803,
                            true);
				...
				if (class47.anInt803 == -1 && class47.childrenIds == null)
					...
					class50_sub1_sub4 = new GameObject(i, i_18_, 0, i_23_, i_24_, i_22_, i_25_, class47.anInt803,
                            true);
				...
				if (class47.anInt803 == -1 && class47.childrenIds == null)
					...
					class50_sub1_sub4 = new GameObject(i, i_18_, 1, i_23_, i_24_, i_22_, i_25_, class47.anInt803,
                            true);
				...
				if (class47.anInt803 == -1 && class47.childrenIds == null) {
					...
					class50_sub1_sub4 = new GameObject(i, 4 + i_18_, 2, i_23_, i_24_, i_22_, i_25_, class47.anInt803,
                            true);
					class50_sub1_sub4_33_ = new GameObject(i, i_32_, 2, i_23_, i_24_, i_22_, i_25_, class47.anInt803,
                            true);
				}
				...
				if (class47.anInt803 == -1 && class47.childrenIds == null)
					...
					class50_sub1_sub4 = new GameObject(i, i_18_, 3, i_23_, i_24_, i_22_, i_25_, class47.anInt803,
                            true);
				class22.method249(i_26_, 49878, 0, anIntArray167[i_18_], null, i_19_, i_27_, i_28_, i_17_,
						class50_sub1_sub4, i_21_);
				if (class47.aBoolean810)
				...
				if (i_16_ == 4) {
					...
					if (class47.anInt803 == -1 && class47.childrenIds == null)
						...
						class50_sub1_sub4 = new GameObject(i, 0, 4, i_23_, i_24_, i_22_, i_25_, class47.anInt803,
                                true);
					...
					if (i_38_ > 0)
						i_37_ = GameObjectDefinition.getDefinition(i_38_ >> 14 & 0x7fff).anInt802;
					Renderable class50_sub1_sub4;
					if (class47.anInt803 == -1 && class47.childrenIds == null)
						class50_sub1_sub4 = class47.getGameObjectModel(4, 0, i_22_, i_23_, i_24_, i_25_, -1);
					else
					...
					for (int i_80_ = -5; i_80_ < anInt152 + 5; i_80_++) {
						...
						if (i_80_ >= 1
								...
								&& (!lowMemory || (aByteArrayArrayArray138[0][i_69_][i_80_] & 0x2) != 0 || ((aByteArrayArrayArray138[i_50_][i_69_][i_80_] & 0x10) == 0 && (method164(
										i_80_, i_50_, i_69_, (byte) 0) == anInt162)))) {
							if (i_50_ < anInt150)
								anInt150 = i_50_;
							...
							if (i_83_ > 0 || i_84_ > 0) {
								...
								int i_98_ = 0;
								if (i_93_ != -1)
									i_98_ = (Rasterizer3D.anIntArray1548[method171(i_94_, 96)]);
								if (i_84_ == 0)
	...
	public static boolean method170(int i, byte i_162_, int i_163_) {
		GameObjectDefinition class47 = GameObjectDefinition.getDefinition(i_163_);
		if (i_162_ != aByte154) {
	...
	public void method172(int i, ClippingPlane[] class46s, SceneGraph class22, boolean bool, byte[] is, int i_166_, int i_167_,
			...
			for (;;) {
				...
				for (;;) {
					...
					if (i_178_ == i_171_ && i_177_ >= i_168_ && i_177_ < i_168_ + 8 && i_176_ >= i_170_
						...
						int i_182_ = (i_169_ + Class34.method350(i_167_, class47.anInt775, i_181_, i_177_ & 0x7,
								(byte) -117, class47.anInt801, i_176_ & 0x7));
						int i_183_ = (i_166_ + Class34.method351(class47.anInt801, i_167_, 671, i_177_ & 0x7,
	...
	public void method173(SceneGraph class22, ClippingPlane class46, int i, int i_185_, int i_186_, byte i_187_, int i_188_,
			int i_189_, int i_190_) {
		if (!lowMemory
				|| (aByteArrayArrayArray138[0][i_186_][i] & 0x2) != 0
				|| ((aByteArrayArrayArray138[i_185_][i_186_][i] & 0x10) == 0 && method164(i, i_185_, i_186_, (byte) 0) == anInt162)) {
			if (i_185_ < anInt150)
				anInt150 = i_185_;
			...
			GameObjectDefinition class47 = GameObjectDefinition.getDefinition(i_190_);
			...
			if (i_189_ == 22) {
				if (!lowMemory || class47.aBoolean759 || class47.aBoolean765) {
					Renderable class50_sub1_sub4;
					if (class47.anInt803 == -1 && class47.childrenIds == null)
						class50_sub1_sub4 = class47.getGameObjectModel(22, i_188_, i_191_, i_192_, i_193_, i_194_, -1);
					else
						class50_sub1_sub4 = new GameObject(i_190_, i_188_, 22, i_192_, i_193_, i_191_, i_194_, class47.anInt803,
                                true);
				...
				Renderable class50_sub1_sub4;
				if (class47.anInt803 == -1 && class47.childrenIds == null)
					class50_sub1_sub4 = class47.getGameObjectModel(10, i_188_, i_191_, i_192_, i_193_, i_194_, -1);
				else
					class50_sub1_sub4 = new GameObject(i_190_, i_188_, 10, i_192_, i_193_, i_191_, i_194_, class47.anInt803,
                            true);
				if (class50_sub1_sub4 != null) {
					int i_198_ = 0;
					if (i_189_ == 11)
					...
					if (class22.method251(i_185_, i_199_, i, class50_sub1_sub4, i_197_, i_198_, i_186_, -896, i_200_,
						...
						if (class50_sub1_sub4 instanceof Model)
							...
							class50_sub1_sub4_sub4 = class47.getGameObjectModel(10, i_188_, i_191_, i_192_, i_193_, i_194_, -1);
						if (class50_sub1_sub4_sub4 != null) {
							for (int i_201_ = 0; i_201_ <= i_199_; i_201_++) {
								for (int i_202_ = 0; i_202_ <= i_200_; i_202_++) {
									int i_203_ = class50_sub1_sub4_sub4.shadowIntensity / 4;
									if (i_203_ > 30)
										i_203_ = 30;
				...
				Renderable class50_sub1_sub4;
				if (class47.anInt803 == -1 && class47.childrenIds == null)
					class50_sub1_sub4 = class47.getGameObjectModel(i_189_, i_188_, i_191_, i_192_, i_193_, i_194_, -1);
				else
					class50_sub1_sub4 = new GameObject(i_190_, i_188_, i_189_, i_192_, i_193_, i_191_, i_194_, class47.anInt803,
                            true);
				...
				Renderable class50_sub1_sub4;
				if (class47.anInt803 == -1 && class47.childrenIds == null)
					class50_sub1_sub4 = class47.getGameObjectModel(0, i_188_, i_191_, i_192_, i_193_, i_194_, -1);
				else
					class50_sub1_sub4 = new GameObject(i_190_, i_188_, 0, i_192_, i_193_, i_191_, i_194_, class47.anInt803,
                            true);
				...
				Renderable class50_sub1_sub4;
				if (class47.anInt803 == -1 && class47.childrenIds == null)
					class50_sub1_sub4 = class47.getGameObjectModel(1, i_188_, i_191_, i_192_, i_193_, i_194_, -1);
				else
					class50_sub1_sub4 = new GameObject(i_190_, i_188_, 1, i_192_, i_193_, i_191_, i_194_, class47.anInt803,
                            true);
				...
				if (class47.anInt803 == -1 && class47.childrenIds == null) {
					class50_sub1_sub4 = class47.getGameObjectModel(2, 4 + i_188_, i_191_, i_192_, i_193_, i_194_, -1);
					class50_sub1_sub4_205_ = class47.getGameObjectModel(2, i_204_, i_191_, i_192_, i_193_, i_194_, -1);
				} else {
					class50_sub1_sub4 = new GameObject(i_190_, 4 + i_188_, 2, i_192_, i_193_, i_191_, i_194_, class47.anInt803,
                            true);
					class50_sub1_sub4_205_ = new GameObject(i_190_, i_204_, 2, i_192_, i_193_, i_191_, i_194_, class47.anInt803,
                            true);
				}
				...
				Renderable class50_sub1_sub4;
				if (class47.anInt803 == -1 && class47.childrenIds == null)
					class50_sub1_sub4 = class47.getGameObjectModel(3, i_188_, i_191_, i_192_, i_193_, i_194_, -1);
				else
					class50_sub1_sub4 = new GameObject(i_190_, i_188_, 3, i_192_, i_193_, i_191_, i_194_, class47.anInt803,
                            true);
				class22.method249(i_195_, 49878, 0, anIntArray167[i_188_], null, i_186_, i_196_, i_197_, i,
						class50_sub1_sub4, i_185_);
				if (class47.aBoolean807) {
				...
				if (i_189_ == 4) {
					Renderable class50_sub1_sub4;
					if (class47.anInt803 == -1 && class47.childrenIds == null)
						class50_sub1_sub4 = class47.getGameObjectModel(4, 0, i_191_, i_192_, i_193_, i_194_, -1);
					else
						class50_sub1_sub4 = new GameObject(i_190_, 0, 4, i_192_, i_193_, i_191_, i_194_, class47.anInt803,
                                true);
					...
					if (i_210_ > 0)
						i_209_ = GameObjectDefinition.getDefinition(i_210_ >> 14 & 0x7fff).anInt802;
					Renderable class50_sub1_sub4;
					if (class47.anInt803 == -1 && class47.childrenIds == null)
						class50_sub1_sub4 = class47.getGameObjectModel(4, 0, i_191_, i_192_, i_193_, i_194_, -1);
					else
	...
	public MapArea(int[][][] is, int i, byte[][][] is_220_, int i_221_, int i_222_) {
		anInt150 = 99;
		anInt151 = i_222_;
		anInt152 = i_221_;
	...
	public void method183(int i, byte i_272_, int i_273_, Buffer class50_sub1_sub2, int i_274_, int i_275_,
		...
		if (i_275_ >= 0 && i_275_ < 104 && i_277_ >= 0 && i_277_ < 104) {
			...
			for (;;) {
				...
				if (i_278_ == 0) {
					if (i_276_ == 0)
						anIntArrayArrayArray149[0][i_275_][i_277_] = -method184(932731 + i_275_ + i, 556238 + i_277_
								+ i_273_) * 8;
					else {
				...
				if (i_278_ <= 49) {
					aByteArrayArrayArray155[i_276_][i_275_][i_277_] = class50_sub1_sub2.getSignedByte();
