...
public class FloorDefinition {
	...
	public static void load(Archive class2) {
		Buffer class50_sub1_sub2 = new Buffer(class2.get("flo.dat"));
		anInt313 = class50_sub1_sub2.getShort();
		if (aClass15Array314 == null)
			aClass15Array314 = new FloorDefinition[anInt313];
		for (int j = 0; j < anInt313; j++) {
			if (aClass15Array314[j] == null)
				aClass15Array314[j] = new FloorDefinition();
	...
	public void method208(byte byte0, Buffer class50_sub1_sub2) {
		...
		do {
			...
			if (j == 0)
				return;
			if (j == 1) {
				anInt316 = class50_sub1_sub2.getTriByte();
				method209(true, anInt316);
			} else if (j == 2)
				anInt317 = class50_sub1_sub2.getUnsignedByte();
			else if (j == 3)
				aBoolean318 = true;
			else if (j == 5)
				aBoolean319 = false;
			else if (j == 6)
				aString315 = class50_sub1_sub2.getString();
			else if (j == 7) {
				int k = anInt320;
				int l = anInt321;
				int i1 = anInt322;
				int j1 = anInt323;
				int k1 = class50_sub1_sub2.getTriByte();
				method209(true, k1);
				anInt320 = k;
				anInt321 = l;
				anInt322 = i1;
